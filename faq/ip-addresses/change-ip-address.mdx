---
title: "Change Your VPS IP Address"
...
<img
  src="/assets/vps-change-ip-recycle-symbol.png"
  alt="Recycle icon for requesting a free IP change"
  style={{ width:"100%",maxWidth:"420px",borderRadius:"16px",border:"1px solid rgba(0,0,0,0.08)" }}
/>
