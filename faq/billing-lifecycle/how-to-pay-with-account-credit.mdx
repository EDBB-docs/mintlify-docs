...
Your **account credit balance** can be used to settle invoices directly from the EDBB Client Panel.
...
1. Sign in to your **Client Panel**
...
<Frame>
  ![Applying account credit to an invoice](/assets/apply-credit.png)
</Frame>
