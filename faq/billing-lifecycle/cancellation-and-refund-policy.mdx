...
<CardGroup cols={2}>
  ...
  <Card title="❌ Not Eligible for Refund">
    <ul>
      <li>More than 24 hours have passed since the original order</li>
      <li>Promo codes, traffic add-ons, or plan upgrades were used</li>
      <li>A refund has already been issued to the same customer within the last 12 months</li>
      <li>The VPS has been suspended for abuse or policy violations</li>
      <li>A free location change has already been completed for the VPS</li>
    </ul>
  </Card>
</CardGroup>
